...
export class RestaurantResolver {
  ...
  async createRestaurants(
    ...
    return this.restaurnatService.createRestaurant(
      authUser,
      createRestaurantInput,
    );
  }
  ...
  @Mutation((retuns) => DeleteRestaurantOutput)
  @Role(['Owner'])
  deleteRestaurant(
    @AuthUser() owner: User,
  ...
  restaurants(
    ...
    return this.restaurnatService.findRestaurants(restaurantsInput);
  }
...
export class CategoryResolver {
  ...
  category(
    ...
    return this.restaurantService.findCategoryBySlue(categoryInput);
  }
}
...
export class DishResolver {
  ...
  createDish(
    ...
    return this.createDish(owner, createDishInput);
  }
}
